...
| `rate_limited` / HTTP 429 | Standard rate limiting; `Retry-After` header gives seconds to wait. **docs**, backoff implemented in `tools/probe.py` but never triggered at our ~1 req/s pace. | — |

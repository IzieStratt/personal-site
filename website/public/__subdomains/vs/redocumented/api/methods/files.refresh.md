...
- call: POST https://slack.com/api/files.refresh
...
---
JSON: https://vs.izie.top/redocumented/api/methods/files.refresh.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

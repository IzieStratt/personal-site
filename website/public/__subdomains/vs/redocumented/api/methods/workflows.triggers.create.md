...
- call: POST https://slack.com/api/workflows.triggers.create
...
---
JSON: https://vs.izie.top/redocumented/api/methods/workflows.triggers.create.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

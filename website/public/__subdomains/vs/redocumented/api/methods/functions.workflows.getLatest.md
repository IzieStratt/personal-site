...
- call: POST https://slack.com/api/functions.workflows.getLatest
...
---
JSON: https://vs.izie.top/redocumented/api/methods/functions.workflows.getLatest.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/usergroups.create
...
| `name` | yes | string | A name for the User Group. Must be unique among User Groups. |
| `team_id` | no | string | Encoded team id where the user group has to be created, required if org token is used. |
...
---
JSON: https://vs.izie.top/redocumented/api/methods/usergroups.create.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/files.collections.delete
...
---
JSON: https://vs.izie.top/redocumented/api/methods/files.collections.delete.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

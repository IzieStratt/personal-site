...
- call: POST https://slack.com/api/entities.refs.add
...
---
JSON: https://vs.izie.top/redocumented/api/methods/entities.refs.add.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

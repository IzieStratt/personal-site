...
- call: POST https://slack.com/api/client.userBoot

Boot org-wide user/client state

## Params

| name | required | type | description |
|---|---|---|---|
| `version_all_channels` | no | boolean |  |
| `return_all_relevant_mpdms` | no | boolean |  |
| `min_channel_updated` | no | number |  |
| `omit_extras` | no | string |  |
...
---
JSON: https://vs.izie.top/redocumented/api/methods/client.userBoot.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

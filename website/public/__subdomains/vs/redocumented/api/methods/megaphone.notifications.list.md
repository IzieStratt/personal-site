...
- call: POST https://slack.com/api/megaphone.notifications.list

"What's new" announcement notifications
...
---
JSON: https://vs.izie.top/redocumented/api/methods/megaphone.notifications.list.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

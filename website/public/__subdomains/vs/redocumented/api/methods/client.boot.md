...
- call: POST https://slack.com/api/client.boot

Boot single-team web client state
...
---
JSON: https://vs.izie.top/redocumented/api/methods/client.boot.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

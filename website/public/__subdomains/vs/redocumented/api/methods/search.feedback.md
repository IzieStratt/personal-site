...
- call: POST https://slack.com/api/search.feedback
...
---
JSON: https://vs.izie.top/redocumented/api/methods/search.feedback.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/email.threads.share
...
---
JSON: https://vs.izie.top/redocumented/api/methods/email.threads.share.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/files.unshare
...
---
JSON: https://vs.izie.top/redocumented/api/methods/files.unshare.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

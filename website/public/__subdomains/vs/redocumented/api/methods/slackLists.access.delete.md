...
- call: POST https://slack.com/api/slackLists.access.delete
...
---
JSON: https://vs.izie.top/redocumented/api/methods/slackLists.access.delete.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

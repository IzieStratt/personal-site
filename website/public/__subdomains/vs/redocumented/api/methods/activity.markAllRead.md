...
- call: POST https://slack.com/api/activity.markAllRead
...
---
JSON: https://vs.izie.top/redocumented/api/methods/activity.markAllRead.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

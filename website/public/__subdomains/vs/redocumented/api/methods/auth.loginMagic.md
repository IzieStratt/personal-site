...
- call: POST https://slack.com/api/auth.loginMagic
...
---
JSON: https://vs.izie.top/redocumented/api/methods/auth.loginMagic.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/email.digest
...
---
JSON: https://vs.izie.top/redocumented/api/methods/email.digest.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

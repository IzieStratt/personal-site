...
- call: POST https://slack.com/api/onboarding.updateUser
...
---
JSON: https://vs.izie.top/redocumented/api/methods/onboarding.updateUser.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

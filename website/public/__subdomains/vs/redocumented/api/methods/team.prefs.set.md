...
- call: POST https://slack.com/api/team.prefs.set
...
---
JSON: https://vs.izie.top/redocumented/api/methods/team.prefs.set.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

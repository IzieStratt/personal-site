...
- call: POST https://slack.com/api/polls.create
...
---
JSON: https://vs.izie.top/redocumented/api/methods/polls.create.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/sfdc.records.delete
...
---
JSON: https://vs.izie.top/redocumented/api/methods/sfdc.records.delete.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

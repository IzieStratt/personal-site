...
- call: POST https://slack.com/api/onboarding.fetch
...
|---|---|---|---|
| `include_team_data` | no | boolean |  |
| `require_invite_list` | no | boolean |  |
...
---
JSON: https://vs.izie.top/redocumented/api/methods/onboarding.fetch.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/functions.distributions.permissions.remove
...
---
JSON: https://vs.izie.top/redocumented/api/methods/functions.distributions.permissions.remove.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

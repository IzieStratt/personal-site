...
- call: POST https://slack.com/api/sfdc.uploadCSVFile
...
---
JSON: https://vs.izie.top/redocumented/api/methods/sfdc.uploadCSVFile.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

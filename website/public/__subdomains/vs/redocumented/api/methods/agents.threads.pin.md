...
- call: POST https://slack.com/api/agents.threads.pin
...
---
JSON: https://vs.izie.top/redocumented/api/methods/agents.threads.pin.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

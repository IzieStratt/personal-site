...
- call: POST https://slack.com/api/auth.emailToken
...
---
JSON: https://vs.izie.top/redocumented/api/methods/auth.emailToken.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

...
- call: POST https://slack.com/api/saved.clearCompleted
...
---
JSON: https://vs.izie.top/redocumented/api/methods/saved.clearCompleted.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

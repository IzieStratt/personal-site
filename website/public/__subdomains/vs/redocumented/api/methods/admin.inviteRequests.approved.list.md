...
- call: POST https://slack.com/api/admin.inviteRequests.approved.list
...
---
JSON: https://vs.izie.top/redocumented/api/methods/admin.inviteRequests.approved.list.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

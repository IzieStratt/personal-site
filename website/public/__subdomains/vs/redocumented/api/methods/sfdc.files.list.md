...
- call: POST https://slack.com/api/sfdc.files.list
...
---
JSON: https://vs.izie.top/redocumented/api/methods/sfdc.files.list.json · Full catalog: https://vs.izie.top/redocumented/llms.txt

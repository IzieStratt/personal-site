...
- call: POST https://slack.com/api/sfdc.fields.create
...
---
JSON: https://vs.izie.top/redocumented/api/methods/sfdc.fields.create.json · Full catalog: https://vs.izie.top/redocumented/llms.txt
